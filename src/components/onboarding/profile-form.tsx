        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              ...
              {step === 2 && "Set your activity level and calorie goal."}
              {step === 3 &&
                "Add your AI API keys to enable food photo analysis."}
              {step === 4 && "Review your profile and daily targets."}
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            {step === 2 && (
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <Label className="flex items-center gap-2">
                    <Target className="w-4 h-4" /> Calorie Goal
                  </Label>
                  <div className="px-1">
                    <Slider
            ...
            {step === 3 && (
              <div className="space-y-4">
                <div className="flex items-start gap-2 p-3 rounded-lg bg-muted/50 text-sm text-muted-foreground">
                  ...
                  <span>
                    You need at least one API key to use AI food photo analysis.
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div className="space-y-1">
                    ...
                    <div className="font-medium capitalize">{sex}</div>
                  </div>
                  <div className="space-y-1">
                ...
                <div className="border-t pt-4">
                  <h3 className="font-semibold mb-3 flex items-center gap-2">
                    <Dumbbell className="w-4 h-4" /> Your Daily Targets
                  </h3>
            ...
            <div className="flex justify-between mt-8">
              ...
              {step < STEPS.length - 1 ? (
                ...
                <Button onClick={handleFinish}>
                  <Check className="w-4 h-4 mr-1" /> Start Tracking
                </Button>
              )}
            </div>
          </CardContent>
