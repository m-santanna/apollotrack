                ...
                <div className="flex justify-center">
                    <div className="w-full sm:w-10/12 md:w-8/12 text-center">
                        <div
                            ...
                            aria-hidden="true"
                        >
                            <h1 className="text-center text-primary text-6xl sm:text-7xl md:text-8xl pt-6 sm:pt-8">
                                404
                            </h1>
                        </div>

                        <div className="mt-[-50px]">
                            <h3 className="text-2xl sm:text-3xl text-primary font-bold mb-4">
                                This page is not available!
                            </h3>
                            <Link to="/">
                                <Button className="text-lg mt-4 w-[200px]">
                                    Go Home
                                </Button>
                            </Link>
                        </div>
